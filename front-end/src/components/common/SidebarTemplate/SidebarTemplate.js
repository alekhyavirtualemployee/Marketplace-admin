            ...
            <div className={classnames('d-flex', {'toggled': this.state.toggled})} id="wrapper">
                ...
                <div className="bg-dark border-right" id="sidebar-wrapper">
                    ...
                    <div className="list-group list-group-flush">
                        ...
                        <Link to='/dashboard' className='list-group-item list-group-item-action bg-dark text-light'><i className="fas fa-users"></i> Transactions</Link>
                        <Link to='/dashboard' className='list-group-item list-group-item-action bg-dark text-light'><i className="fas fa-search"></i> Settings</Link>
                        <Link to='/dashboard' className='list-group-item list-group-item-action bg-dark text-light'><i className="fas fa-user"></i>   Profile</Link>
                    </div>
                </div>
                {/*  /#sidebar-wrapper */}
